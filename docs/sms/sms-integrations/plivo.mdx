...
### Step 2. Plivo Integration in Raven

| Keys       | Details                                                                                                                                                      |
| ---------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| `Auth Key` | Plivo Auth Token. You can find it on the home screen of your [Plivo Console](https://console.plivo.com/accounts/login/?next=/dashboard/).                    |
| `Auth ID`  | Plivo Auth ID. You can find it on the home screen of your [Plivo Console](https://console.plivo.com/accounts/login/?next=/dashboard/).                       |
