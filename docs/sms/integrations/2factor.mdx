...
| Api Key       | If you are signed up in 2Factor.in, you can get your api key here                                                                                                                                                                                                                                        |
| Sender Id     | Sender id to be sent with the SMS. It has to be a preconfigured 6 characters alphabetical sender id for the enterprise account. The Sender ID should be linked with the SMS template as registered on DLT portal. Learn more about DLT Sender Id here                                                    |
...
| Callback URL  | This is an optional field where you can assign your system callback url to get all reports at your database endpoint                                                                                                                                                                                     |
