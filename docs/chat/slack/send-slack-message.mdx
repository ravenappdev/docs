...
You need to
[create a slack app](https://slack.com/intl/en-in/help/articles/115005265703-Create-a-bot-for-your-workspace),
...
Head over to [Channels tab](https://console.raven.dev/app/channels) in the
dashboard and select Slack.
...
support@ravenapp.dev, and we will add it to the list.
...
2. Select Slack as a channel to send notifications. Also, select the Integration
   that you added earlier in Step 2.
3. Create the notification template. You can add dynamic text to the template
   ...
   please check our Slack Template doc.

<iframe
  class="w-full h-96"
  src="https://www.loom.com/embed/8f816c9c562141458cd5678d6d23c114"></iframe>
...
![Event Timeline](/images/event-timeline-2.png)
